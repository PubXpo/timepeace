# Note:
<!-- add description -->
The purpose of the samples is to showcase ability to use programming languages to produce features to complete the goals of the project. It shows TDD by using JUnit and Mockito to test functions before implementing into the product. There are instance of Logging which demonstrates the understanding of different log levels to assist in troubleshooting and maintenance.
<br></br>
